                       ...
                       QList<QString> columnNames, QList<int> columnWidths, QStringList content)
{
    ...
    html.append("   <Font ss:FontName=\"微软雅黑\" x:CharSet=\"134\" ss:Size=\"14\" ss:Color=\"#000000\" ss:Bold=\"1\"/>\n");
    html.append("  </Style>\n");
    //带边框样式
    ...
    for (int i = 0; i < columnCount; i++) {
        html.append(QString("   <Column ss:AutoFitWidth=\"0\" ss:Width=\"%1\"/>\n")
                    .arg(QString::number(columnWidths.at(i))));
    }
    ...
    for (int i = 0; i < columnCount; i++) {
        html.append(QString("    <Cell ss:StyleID=\"s91\"><Data ss:Type=\"String\">%1</Data></Cell>\n")
